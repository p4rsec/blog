  ...
  return (
    <nav className="container mx-auto px-4 py-4">
      <div className="max-w-4xl mx-auto">
        <div className="bg-terminal-bg border border-terminal-border shadow-terminal">
          {/* <div className="bg-terminal-border/20 border-b border-terminal-border px-4 py-2">
